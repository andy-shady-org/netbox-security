...
class SecurityZonePolicySerializer(NetBoxModelSerializer):
    ...
    def validate(self, data):
        ...
        if isinstance(data, dict):
            if (source_zone := data.get("source_zone")) is not None and (destination_zone := data.get("destination_zone")) is not None:
            ...
            if (source_address := data.get("source_address")) is not None and (destination_address := data.get("destination_address")) is not None:
