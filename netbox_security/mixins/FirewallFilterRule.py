...
class FilterRuleFromSettingMixin:
    ...
    def _append_settings_fields(self):
        ...
        for key, label in FirewallRuleSettingChoices.CHOICES:
            initial = None
            ...
            if FirewallRuleSettingChoices.FIELD_TYPES[key] == 'ipaddr':
            ...
            elif FirewallRuleSettingChoices.FIELD_TYPES[key] == 'integer':
                ...
                css = self.fields[key].widget.attrs.get('class', '')
                self.fields[key].widget.attrs['class'] = f'{css} form-control'
            elif FirewallRuleSettingChoices.FIELD_TYPES[key] == 'boolean':
                choices = (
                    (None, '---------'),
                    (True, _('True')),
                    (False, _('False')),
    ...
    def save(self, *args, **kwargs):
        settings = {}
        for key, _ in FirewallRuleSettingChoices.CHOICES:
