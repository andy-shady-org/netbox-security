...
urlpatterns = [
    ...
    path("address/<int:pk>/", include(get_model_urls("netbox_security", "address")),),
    # Address Sets
    ...
    path('address-set/delete', views.AddressSetBulkDeleteView.as_view(), name='addressset_bulk_delete'),
    path('address-set/edit', views.AddressSetBulkEditView.as_view(), name='addressset_bulk_edit'),
    path('address-set/import', views.AddressSetBulkImportView.as_view(), name='addressset_import'),
    path('address-set/<int:pk>/', views.AddressSetView.as_view(), name='addressset'),
    path('address-set/<int:pk>/edit/', views.AddressSetEditView.as_view(), name='addressset_edit'),
    path('address-set/<int:pk>/delete/', views.AddressSetDeleteView.as_view(), name='addressset_delete'),
    path(
        "address-set/<int:pk>/",
    ...
    path('nat-pool-member/edit', views.NatPoolMemberBulkEditView.as_view(), name='natpoolmember_bulk_edit'),
    ...
    path('nat-rule/edit', views.NatRuleBulkEditView.as_view(), name='natrule_bulk_edit'),
